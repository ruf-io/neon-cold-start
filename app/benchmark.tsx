import FancyProgressBar from "@/components/fancyLoader";
    ...
    return (
        <>
            <div className="w-min">
                <button
                    type="button"
                    // bg-gradient-to-r from-indigo-500 from-10% to-inherit to-30%
                ...
                <div className={`mt-1 ${benchmarking ? "visible" : "invisible"}`}>
                    <FancyProgressBar progress={((benchmarkRun || 0) / maxBenchmarRuns) * 100} />
                </div>
            </div>
        </>
    );
