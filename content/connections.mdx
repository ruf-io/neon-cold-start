...
Each of these steps involves at least one trip between client and host. That makes **Client\<-\>Database proximity** is the biggest factor in the time required to establish a connection.
