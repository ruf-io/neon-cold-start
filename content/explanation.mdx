  ...
  <div>
    ...
    <div className="form-control">
        <label className="label cursor-pointer">
            ...
            <input type="range" min="0" max="100000000" className="range range-primary" />
        </label>
    </div>
    <div className="form-control">
        <label className="label cursor-pointer">
            <span className="label-text">Active Business Hrs</span> 
            <input type="checkbox" className="toggle" />
            <span className="label-text">24/7</span>
        </label>
    </div>
    <div className="form-control">
        <label className="label cursor-pointer">
            <span className="label-text">Suspend After</span> 
...
## Try Running the Benchmarks Yourself

This repo is configured to make it easy 